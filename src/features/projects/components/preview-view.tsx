...
import { PreviewSettingsPopover, PreviewTerminal, useWebContainer } from "@/features/preview";
import { useProject } from "../hooks";

interface IPreviewViewProps {
  projectId: Id<"projects">;
}

export const PreviewView = ({ projectId }: IPreviewViewProps) => {
