...
import {ScrollArea, ScrollBar, Spinner} from "@/components/ui";
import {useEditor} from "@/features/editor";
import {useFile} from "@/features/projects";
...
const Tab = ({ fileId, isFirst, projectId }: ITabProps) => {
...
export const TopNavigation = ({ projectId }: ITopNavigationProps) => {
