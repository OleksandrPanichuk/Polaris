...
type TSuggestionRequest = z.infer<typeof suggestionRequestSchema>;
type TSuggestionResponse = z.infer<typeof suggestionResponseSchema>;

export const fetcher = async (
  payload: TSuggestionRequest,
  signal: AbortSignal,
) => {
  try {
